...
## Environments
- Preview: https://main--7brew-eds--Bounteous-Inc.aem.page/
- Live: https://main--7brew-eds--Bounteous-Inc.aem.live/
...
1. Open the `7brew-eds` directory in your favorite IDE and start coding :)
